...
copy your personal key from the dashboard.
Rename the (.env_example) file to (.env) exactly.
open the (.env) file and paste your API key in the designated field.
Then Run the application and make sure you have the required libraries.